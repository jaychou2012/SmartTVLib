...
public class AutoHorizontalGridView extends BaseGridView {
    ...
    public AutoHorizontalGridView(Context context) {
        this(context, null);
    }

    public AutoHorizontalGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoHorizontalGridView(Context context, AttributeSet attrs, int defStyle) {
