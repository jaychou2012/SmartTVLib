...
public class Picker extends FrameLayout {
    ...
    final List<AutoVerticalGridView> mColumnViews = new ArrayList<AutoVerticalGridView>();
    ...
    public void setColumns(List<PickerColumn> columns) {
        ...
        for (int i = 0; i < totalCol; i++) {
            ...
            final AutoVerticalGridView columnView = (AutoVerticalGridView) inflater.inflate(
            ...
            columnView.setWindowAlignment(AutoVerticalGridView.WINDOW_ALIGN_NO_EDGE);
    ...
    public void setColumnAt(int columnIndex, PickerColumn column) {
        ...
        AutoVerticalGridView columnView = mColumnViews.get(columnIndex);
    ...
    void updateColumnAlpha(int colIndex, boolean animate) {
        AutoVerticalGridView column = mColumnViews.get(colIndex);
    ...
    private void updateColumnSize(AutoVerticalGridView columnView) {
    ...
    private void updateItemFocusable() {
        ...
        for (int i = 0; i < getColumnsCount(); i++) {
            AutoVerticalGridView grid = mColumnViews.get(i);
