...
abstract class Grid {
     ...
     * responsibility to perform removing child action, {@link (int)} will not
    ...
    /**
     * Gets {@link } of item.  The return object is read only and temporarily.
     */
